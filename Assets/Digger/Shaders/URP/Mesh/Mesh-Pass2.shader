Shader "Digger/Mesh/URP/Lit-Pass2"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "Queue" = "Geometry-103" "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "True" "DisableBatching" = "True"}
