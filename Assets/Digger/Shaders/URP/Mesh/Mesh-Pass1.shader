Shader "Digger/Mesh/URP/Lit-Pass1"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "Queue" = "Geometry-104" "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "True" "DisableBatching" = "True"}
