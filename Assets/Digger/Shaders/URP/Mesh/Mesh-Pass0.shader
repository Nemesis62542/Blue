Shader "Digger/Mesh/URP/Lit-Pass0"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "Queue" = "Geometry-105" "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "False" "DisableBatching" = "True"}
