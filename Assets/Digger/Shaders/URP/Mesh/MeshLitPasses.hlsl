...
void NormalMapMix(float3 positionWS, float3 normal, inout half4 splatControl, inout half3 mixedNormal)
{
    #if defined(_NORMALMAP)
        half3 nrm = 0.0f;
        nrm += splatControl.r * UnpackNormalScale(SampleTriplanar(splatControl.r, positionWS, normal, _Normal0, sampler_Normal0, _Splat0_ST.xy, _Splat0_ST.zw), _NormalScale0);
        nrm += splatControl.g * UnpackNormalScale(SampleTriplanar(splatControl.g, positionWS, normal, _Normal1, sampler_Normal0, _Splat1_ST.xy, _Splat1_ST.zw), _NormalScale1);
        nrm += splatControl.b * UnpackNormalScale(SampleTriplanar(splatControl.b, positionWS, normal, _Normal2, sampler_Normal0, _Splat2_ST.xy, _Splat2_ST.zw), _NormalScale2);
        nrm += splatControl.a * UnpackNormalScale(SampleTriplanar(splatControl.a, positionWS, normal, _Normal3, sampler_Normal0, _Splat3_ST.xy, _Splat3_ST.zw), _NormalScale3);
...
void SplatmapMix(float3 positionWS, float3 normal, inout half4 splatControl, out half weight, out half4 mixedDiffuse, out half4 defaultSmoothness, inout half3 mixedNormal)
{
    ...
    diffAlbedo[0] = SampleTriplanar(splatControl.r, positionWS, normal, _Splat0, sampler_Splat0, _Splat0_ST.xy, _Splat0_ST.zw);
    diffAlbedo[1] = SampleTriplanar(splatControl.g, positionWS, normal, _Splat1, sampler_Splat0, _Splat1_ST.xy, _Splat1_ST.zw);
    diffAlbedo[2] = SampleTriplanar(splatControl.b, positionWS, normal, _Splat2, sampler_Splat0, _Splat2_ST.xy, _Splat2_ST.zw);
    diffAlbedo[3] = SampleTriplanar(splatControl.a, positionWS, normal, _Splat3, sampler_Splat0, _Splat3_ST.xy, _Splat3_ST.zw);
    ...
    NormalMapMix(positionWS, normal, splatControl, mixedNormal);
}
...
#if defined(DYNAMICLIGHTMAP_ON)
    o.dynamicLightmapUV = v.texcoord1 * unity_DynamicLightmapST.xy + unity_DynamicLightmapST.zw;
#endif
...
{
    return GenericSplatmapVert(v, v.texcoord4);
}
Varyings SplatmapVert3(Attributes v)
{
    return GenericSplatmapVert(v, v.texcoord5);
}
...
#ifdef _MASKMAP
    masks[0] = lerp(masks[0], SampleTriplanar(splatControl.r, IN.positionWS, adjustedNormal, _Mask0, sampler_Mask0, _Splat0_ST.xy, _Splat0_ST.zw), hasMask.x);
    masks[1] = lerp(masks[1], SampleTriplanar(splatControl.g, IN.positionWS, adjustedNormal, _Mask1, sampler_Mask0, _Splat1_ST.xy, _Splat1_ST.zw), hasMask.y);
    masks[2] = lerp(masks[2], SampleTriplanar(splatControl.b, IN.positionWS, adjustedNormal, _Mask2, sampler_Mask0, _Splat2_ST.xy, _Splat2_ST.zw), hasMask.z);
    masks[3] = lerp(masks[3], SampleTriplanar(splatControl.a, IN.positionWS, adjustedNormal, _Mask3, sampler_Mask0, _Splat3_ST.xy, _Splat3_ST.zw), hasMask.w);
#endif
...
#endif
{
    ...
    float3 adjustedNormal = AdjustedNormalTriplanar(IN.bary, IN.positionWS, IN.normal.xyz);
    ...
    SplatmapMix(IN.positionWS, adjustedNormal, splatControl, weight, mixedDiffuse, defaultSmoothness, normalTS);
